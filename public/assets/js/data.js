...
let $phone_brand = [
    '360', 'Alcatel','Apple', 'Asus', 'Realme', 'Blu', 'Google', 'HiSense', 'Hp', 'InnJoo',
    'Honor', 'TCL', 'CAT', 'Elephone', 'Haier', 'Infinix', 'Samsung', 'Acer', 'Blackberry',
    'Microsoft', 'Itel', 'LG', 'Nokia', 'Techno', 'Sony', 'Sony Ericsson', 'OPPO', 'OnePlus',
    'Tesla', 'Toshiba', 'Lenovo', 'Motorola', 'Huawei', 'HTC', 'Vivo', 'Wiko', 'Xiaomi', 'YU',
    'ZTE', 'Autre'
];

let $tablette_brand = [
    'Apple', 'Asus', 'Samsung', 'Acer', 'Blackberry', 'Microsoft', 'Itel', 'Techno',
    'Google', 'Sony', 'Toshiba', 'HP', 'Lenovo', 'Motorola', 'Huawei', 'HTC', 'Autre'
];

let $ordinateur_portable_brand = [
    'Acer', 'Apple', 'Asus', 'Compaq', 'Dell', 'Fujitsu', 'Gateway', 'Gigabyte', 'Huawei',
    'Hp', 'IBM', 'Intel', 'Lenovo', 'Medion', 'Microsoft', 'ORDISSIMO', 'Razer', 'Samsung',
    'Toshiba', 'Sony', 'MSI', 'Autre'
];

let $ordinateur_bureau_brand = [
    'Acer', 'Apple', 'Asus', 'Compaq', 'Dell', 'Fujitsu', 'Gateway', 'Gigabyte',
    'Huawei', 'Hp', 'IBM', 'Intel', 'Lenovo', 'Medion', 'Microsoft', 'ORDISSIMO', 'Razer',
    'Samsung', 'Toshiba', 'Sony', 'MSI', 'Autre'
];

let $jeux_video_brand = [
    'Nintendo DS', 'Nintendo 3DS', 'Nintendo Switch', 'Nintendo Wii', 'Nintendo Wii U',
    'PlayStation 5', 'PlayStation 4', 'PlayStation 3', 'PlayStation 2', 'PlayStation One',
    'PlayStation Vita', 'Sony PSP', 'XBOX One', 'Xbox Series', 'XBOX 360', 'Autre'
];
