...
class CommandeController extends AbstractController
{
    ...
    #[Route(path: '/commandes/{id}/advert', name: 'app_admin_commande_advert', requirements: ['id' => '\d+'])]
    public function byAdvert(Request $request, Advert $advert): Response
    {
        $qb = $this->repository->findBy(['advert' => $advert], ['createdAt' => 'desc']);
