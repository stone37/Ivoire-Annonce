...
class ColocationsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nombrePiece', ImmobilierNombrePieceChoiceType::class, [
                'label' => 'Nombre de pièces (facultatif)',
            ...
            ->add('nombreChambre', IntegerType::class, ['label' => 'Nombre de chambre(s)', 'required' => false])
            ->add('nombreSalleBain', IntegerType::class, ['label' => 'Nombre de salle(s) de bain', 'required' => false])
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'validation_groups' => ['Default', 'COLOCATION']
        ]);
    }
