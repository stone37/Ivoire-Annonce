...
class LocationsDeVehiculesType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('type', ChoiceType::class, [
                'choices' => [
                    'Offre de véhicule à louer' => Advert::TYPE_OFFER,
                    'Recherche de véhicule à louer' => Advert::TYPE_RESEARCH
                ],
                'expanded' => true,
                'multiple' => false,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'validation_groups' => ['Default', 'LOCATION_VOITURE']
        ]);
    }
